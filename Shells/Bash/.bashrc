...
export PATH=~/.bin:/bin/lscript:/bin/lscript:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:.
...
fzf-wordlist-widget() {
  if __fzf_use_tmux__; then
    ...
    local selected="$(__fzf_worlists__)"
    READLINE_LINE="${READLINE_LINE:0:$READLINE_POINT}$selected${READLINE_LINE:$READLINE_POINT}"
    READLINE_POINT=$(( READLINE_POINT + ${#selected} ))
  fi
}
bind -x '"\C-p": "fzf-wordlist-widget"'
fi
...
alias cd="mycd"
export PATH=/bin/lscript:/bin/lscript:/home/scot/.bin:/bin/lscript:/bin/lscript:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:.
